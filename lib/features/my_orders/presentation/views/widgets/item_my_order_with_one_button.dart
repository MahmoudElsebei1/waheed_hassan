...
class ItemMyOrderWithOneButton extends StatelessWidget {
  const ItemMyOrderWithOneButton({super.key});
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Spacer(),
              Container(
                padding: EdgeInsets.fromLTRB(12.5, 4, 6.5, 4),
                decoration: BoxDecoration(
                ...
                child: Row(
                  children: [
                    SvgPicture.asset('assets/my_orders_assets/done.svg'),
                    Gap(6.w),
                    Text(
                      'تم التسليم',
                      style: TextStyle(
